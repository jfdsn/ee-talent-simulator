...
const talents = [
    ...
    { id: "Shield1", icon: "knight/placeholder.webp", row: 1, col: 6, maxLevel: 5, description: "For each level up, apenas testando +5%." },
    { id: "Shield2", icon: "knight/placeholder.webp", row: 2, col: 1, maxLevel: 5, description: "For each level up, apenas testando +5%." },
    { id: "Shield3", icon: "knight/placeholder.webp", row: 2, col: 2, maxLevel: 5, description: "For each level up, apenas testando +5%."},
